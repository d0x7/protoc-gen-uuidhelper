...
// Versions:
// - protoc-gen-uuidhelper-go v0.2.3+dirty
// - protoc v5.29.3
// source: test.proto
...
func (m *Player) GetMapInt32UUID() map[int32]uuid.UUID {
...
func (m *Player) SetMapInt32UUID(u map[int32]uuid.UUID) {
	if len(u) == 0 {
		m.MapInt32Uuid = nil
		return
	}
...
func (m *Player) GetMapInt64UUID() map[int64]uuid.UUID {
...
func (m *Player) SetMapInt64UUID(u map[int64]uuid.UUID) {
	if len(u) == 0 {
		m.MapInt64Uuid = nil
		return
	}
...
func (m *Player) GetMapUint32UUID() map[uint32]uuid.UUID {
...
func (m *Player) SetMapUint32UUID(u map[uint32]uuid.UUID) {
	if len(u) == 0 {
		m.MapUint32Uuid = nil
		return
	}
...
func (m *Player) GetMapUint64UUID() map[uint64]uuid.UUID {
...
func (m *Player) SetMapUint64UUID(u map[uint64]uuid.UUID) {
	if len(u) == 0 {
		m.MapUint64Uuid = nil
		return
	}
...
func (m *Player) GetMapSint32UUID() map[int32]uuid.UUID {
...
func (m *Player) SetMapSint32UUID(u map[int32]uuid.UUID) {
	if len(u) == 0 {
		m.MapSint32Uuid = nil
		return
	}
...
func (m *Player) GetMapSint64UUID() map[int64]uuid.UUID {
...
func (m *Player) SetMapSint64UUID(u map[int64]uuid.UUID) {
	if len(u) == 0 {
		m.MapSint64Uuid = nil
		return
	}
...
func (m *Player) GetMapFixed32UUID() map[uint32]uuid.UUID {
...
func (m *Player) SetMapFixed32UUID(u map[uint32]uuid.UUID) {
	if len(u) == 0 {
...
func (m *Player) GetMapFixed64UUID() map[uint64]uuid.UUID {
...
func (m *Player) SetMapFixed64UUID(u map[uint64]uuid.UUID) {
	if len(u) == 0 {
...
func (m *Player) GetMapSfixed32UUID() map[int32]uuid.UUID {
...
func (m *Player) SetMapSfixed32UUID(u map[int32]uuid.UUID) {
	if len(u) == 0 {
...
func (m *Player) GetMapSfixed64UUID() map[int64]uuid.UUID {
...
func (m *Player) SetMapSfixed64UUID(u map[int64]uuid.UUID) {
	if len(u) == 0 {
...
func (m *Player) GetMapBoolUUID() map[bool]uuid.UUID {
...
func (m *Player) SetMapBoolUUID(u map[bool]uuid.UUID) {
	if len(u) == 0 {
		m.MapBoolUuid = nil
		return
	}
...
func (m *Player) GetMapStringUUID() map[string]uuid.UUID {
...
func (m *Player) SetMapStringUUID(u map[string]uuid.UUID) {
	if len(u) == 0 {
		m.MapStringUuid = nil
		return
	}
...
func (m *Child) GetMapChildUUID() map[string]uuid.UUID {
...
func (m *Child) SetMapChildUUID(u map[string]uuid.UUID) {
	if len(u) == 0 {
		m.MapChildUuid = nil
		return
	}
